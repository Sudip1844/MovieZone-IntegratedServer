...
function renderDownloadLinks(linkData) {
    ...
    let html = `
        <div style="background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.08); border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.2); backdrop-filter: blur(16px); padding:25px; margin:20px auto; max-width:600px; text-align:center;">
            <h2 style="margin:0 0 20px 0;font-size:22px;color:#ffd700;">${linkData.title || "Movie Download Options"}</h2>
